    ...
    const projects = [
        {
            ...
            image : './src/images/shakenorstirred.png'
        },
        {
            id:'id2',
            title : 'Crunch Track',
            ...
            image : './src/images/crunchTrack.png'
        },
        {
            id:'id2',
            title : 'Crunch Track',
        ...
        },
        {
            ...
            image : './Users/Tomiceva/bootcamp/homework/weeek20/Jelena-s-portfolio/portfolio/src/images/socialNetworkAPI.png'
        },
        {
            id:'id6',
            ...
            text: 'We had to make weather app that show current temperature, humidity, wind and uv of the city along with forecast for next 5 days. We also had to show our knowledge using API.' ,
            image : './src/images/socialNetworkAPI.png'
        },
    ]
    return (
        <section >
